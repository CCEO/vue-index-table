<template>
    <div class="dynamic-tables">
        <b-breadcrumb>
            <b-breadcrumb-item><a :href="homeURL"><i class="fa fa-home"></i></a></b-breadcrumb-item>
                ...
                <div slot="actions" slot-scope="props">
                    <b-button-group size="sm">
                        <b-button class="btn-rounded-f pull-right" v-for="button in buttons"
                                  v-b-modal="button.name" :variant="button.variant" :href="button.URL" @click="showModal(button)">
